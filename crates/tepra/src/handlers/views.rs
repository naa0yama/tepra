...
/// Neutral notice shown when `lwstatus` 404s mid-print (printer busy),
/// distinguished from a true connection failure (`CREATOR_API_ERROR`).
const LW_STATUS_BUSY_NOTICE: &str = "印刷中はステータスを取得できません";
